...
@section('content')
    @include('sections.sections.presentation')
    
    @include('sections.sections.categories')
    
    @include('sections.sections.achievements')
    
    @include('sections.sections.workProcess')
    
    @include('sections.sections.inspirations')
    
    @include('sections.sections.hiring')
    
    @include('sections.sections.suscribe')
    
    @include('sections.sections.reviews')
    
    @include('sections.sections.reliability')
    
    @include('sections.sections.blog')
    
    @include('sections.sections.joinUs')
